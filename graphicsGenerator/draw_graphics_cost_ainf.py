...
output_file = f"fgrafico_costos_bfs_a_star_{file_name}.png"
...
means = [data["bfs"]["cost_mean"]] + [data["a_star"][method]["cost_mean"] for method in methods]
std_devs = [data["bfs"]["cost_std"]] + [data["a_star"][method]["cost_std"] for method in methods]
...
plt.title("Comparación de costos de búsqueda con desviación estándar")
